...
func TestSiteLoaderMangatown(t *testing.T) {
	...
	collection, err := LoadComicFromSource(conf, "www.mangatown.com", url, "", "")
...
func TestSiteLoaderMangarock(t *testing.T) {
	...
	conf := new(config.ComicConfig)
	collection, err := LoadComicFromSource(conf, "mangarock.com", url, "italy", "")
...
func TestSiteLoaderMangareader(t *testing.T) {
	...
	conf := new(config.ComicConfig)
	collection, err := LoadComicFromSource(conf, "www.mangareader.net", url, "", "")
...
func TestSiteLoaderComicExtra(t *testing.T) {
	...
	conf := new(config.ComicConfig)
	collection, err := LoadComicFromSource(conf, "www.comicextra.com", url, "", "")
...
func TestLoaderUnknownSource(t *testing.T) {
	...
	collection, err := LoadComicFromSource(conf, "example.com", url, "", "")
